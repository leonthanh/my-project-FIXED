...
const EditWritingTest = lazy(() => import('../../../features/writing/pages/EditWritingTest'));
...
export const buildIxWritingRoutes = ({ isAuthenticated }) => [
  ...
  <Route key="edit-test" path="/edit-test/:id" element={renderProtected('teacher', <EditWritingTest />)} />,
];
