...
import MoversListeningTestBuilder from "../../movers/listening/pages/MoversListeningTestBuilder";
...
const EditCambridgeListeningTestPage = () => {
	const { id } = useParams();
...
export default EditCambridgeListeningTestPage;