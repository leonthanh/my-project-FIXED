...
export const QUESTION_TYPES = {
  ...
  'inline-choice': {
    ...
    labelVi: 'Chọn đáp án trong đoạn văn',
    iconName: 'chevron-down',
    description: 'PET Part 5: Chọn đáp án A-D ngay trong đoạn văn',
    ...
    defaultData: {
      ...
      blanks: [
        ...
        { number: 23, options: ['', '', '', ''], correctAnswer: '' },
        { number: 24, options: ['', '', '', ''], correctAnswer: '' },
        { number: 25, options: ['', '', '', ''], correctAnswer: '' },
        { number: 26, options: ['', '', '', ''], correctAnswer: '' },
      ],
    },
  ...
  'short-message': {
    ...
    defaultData: {
      ...
      mediaUrl: '', // Legacy single GIF/ảnh URL
      mediaUrls: ['', '', ''], // Tối đa 3 GIF/ảnh URL
...
const KET_LISTENING_QUESTION_TYPES = KET_UNIFIED_QUESTION_TYPES;
