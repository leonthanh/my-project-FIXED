    ...
    case "facebook":
      return (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="none">
          <path
            fill="currentColor"
            d="M13.64 21v-7.18h2.42l.36-2.8h-2.78V9.24c0-.81.23-1.36 1.39-1.36h1.48V5.37c-.26-.04-1.14-.11-2.17-.11-2.15 0-3.62 1.31-3.62 3.71v2.06H8.29v2.8h2.43V21h2.92Z"
          />
        </svg>
      );
    case "google":
      return (
        <svg {...props} viewBox="0 0 24 24" fill="none" stroke="none">
          <path
            fill="#4285F4"
            d="M21.6 12.23c0-.68-.06-1.33-.19-1.95H12v3.69h5.38a4.6 4.6 0 0 1-1.99 3.02v2.5h3.22c1.88-1.73 2.99-4.28 2.99-7.26Z"
          />
          <path
            fill="#34A853"
            d="M12 22c2.7 0 4.97-.9 6.62-2.43l-3.22-2.5c-.89.6-2.03.95-3.4.95-2.61 0-4.82-1.76-5.61-4.12H3.07v2.57A10 10 0 0 0 12 22Z"
          />
          <path
            fill="#FBBC05"
            d="M6.39 13.9A5.97 5.97 0 0 1 6.07 12c0-.66.11-1.3.32-1.9V7.53H3.07A10 10 0 0 0 2 12c0 1.61.39 3.13 1.07 4.47l3.32-2.57Z"
          />
          <path
            fill="#EA4335"
            d="M12 5.98c1.47 0 2.78.51 3.81 1.5l2.86-2.86C16.97 3.06 14.7 2 12 2A10 10 0 0 0 3.07 7.53L6.39 10.1C7.18 7.74 9.39 5.98 12 5.98Z"
          />
        </svg>
      );
    case "zalo":
