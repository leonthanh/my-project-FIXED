      ...
      <div className="result-modal" style={{color:'#0e276f'}} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="result-modal-body">
          ...
          <div style={{ marginTop: 18 }}>
            <p style={{ color: '#06c' }}><strong>Chi tiết:</strong></p>
            <ul>
        ...
        <style>{`
          ...
          .result-modal-footer { display:flex; padding: 0; background: #ffffffff; min-height: 12px }
          .btn { padding: 8px 12px; border-radius: 8px; cursor:pointer }
          .btn-primary { background: #e03; color: #fff; border: none }
