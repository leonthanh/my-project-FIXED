...
const useKeyboardShortcuts = (handlers = {}, enabled = true) => {
  ...
  return {
    shortcuts: [
      ...
      { key: 'Ctrl+N', action: 'Thêm câu hỏi mới', enabled: !!handlers.onAddQuestion },
      { key: 'Ctrl+P', action: 'Xem trước (Preview)', enabled: !!handlers.onPreview },
      { key: 'Ctrl+D', action: 'Dark/Light mode', enabled: !!handlers.onToggleTheme },
