...
const QUESTION_TEMPLATES = {
  ...
  'true-false-notgiven': [
    ...
    },
    {
      ...
      template: {
        type: 'true-false-notgiven',
        questionText: 'The author believes that technology has improved education.',
  ...
  'fill-in-blank': [
    {
      ...
      template: {
        type: 'fill-in-blank',
        questionText: 'Complete the table below using NO MORE THAN TWO WORDS from the passage.',
        correctAnswer: ''
      }
    },
    {
  ...
  'matching': [
    {
      ...
      template: {
        ...
        matchingOptions: ['Researcher A', 'Researcher B', 'Researcher C', 'Researcher D']
      }
    },
    {
  ...
  'cloze-test': [
    {
      ...
      template: {
        type: 'cloze-test',
        passage: 'The study found that {{1}} was crucial for {{2}}. Researchers concluded that {{3}} played a significant role.',
        blanks: [
          { id: 1, correctAnswer: '' },
          { id: 2, correctAnswer: '' },
          { id: 3, correctAnswer: '' }
        ],
        wordBank: ['education', 'development', 'technology', 'communication', 'innovation']
      }
    }
  ]
};
...
const CATEGORY_INFO = {
  ...
  'true-false-notgiven': { icon: '✅', label: 'True/False/Not Given', color: '#27ae60' },
  'fill-in-blank': { icon: '📝', label: 'Fill in Blank', color: '#9b59b6' },
  'matching': { icon: '🔗', label: 'Matching', color: '#e67e22' },
  'ielts-matching-headings': { icon: '📑', label: 'Matching Headings', color: '#e74c3c' },
    ...
    <div style={modalStyle} onClick={onClose}>
      <div style={contentStyle} onClick={e => e.stopPropagation()}>
        ...
        <div style={{
          ...
          <span>Tổng: {Object.values(QUESTION_TEMPLATES).flat().length} mẫu</span>
        </div>
      </div>
    </div>
  );
