            ...
            <>
              ...
              >
                ...
                <p className="admin-side-layout__panelText">
                  Use the filters on the right to narrow the queue, then open any row to review scores and feedback.
                </p>
              </AdminSidebarPanel>
            </>
          )}
                  ...
                  {submission.feedback ? (
                    ...
                    >
                      <p style={{ margin: "0 0 6px", fontSize: 13, color: isDarkMode ? "#bbf7d0" : "#166534" }}>
                        <strong>Reviewed</strong> at {formatAttemptTimestamp(submission.feedbackAt)} by <strong>{submission.feedbackBy || "Reviewed"}</strong>
                      </p>
